  ...
  const handleSearch = (event, userSearchInput) => {
    ...
    const filteredBreedInfo = initialBreedInfo.filter((breed) => {
      ...
      return (
        ...
        breed.origin?.toLowerCase().includes(userSearchInput) ||
        breed.name?.toLowerCase().includes(userSearchInput) ||
        breed.temperament?.toLowerCase().includes(userSearchInput) ||
        breed.description?.toLowerCase().includes(userSearchInput)
      );
    });
      ...
      <div className="wrapper">
        <div className="breed-info--container">
          <div className="breed-info--search">
            ...
            <p className="breed-info--title-sub">
              Welcome to the Breed Information API. We often are asked many
              questions about breeds, usually about which is "best" to either
              adopt or purchase as a puppy. We always encourage you to do as
              much of your own research as possible, from many different -
              trusted - sources, but please feel free to type in any keyword
              below (breed name, country, breed traits or personality traits,
              etc...) to learn more your breed of interest! Click on or
              hover-over the image to reveal traits about each breed.
            </p>
